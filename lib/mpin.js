  ...
  Mpin.prototype.generateUrl = function (type, options) {
    ...
    switch (type) {
      ...
      case "permit2":
        ...
        hash_mpin_id_bytes = this.ctx.MPIN.HASH_ID(this.ctx.MPIN.HASH_TYPE, mpin_id_bytes);
 ...
 */
  Mpin.prototype._calculateMPinToken = function (mpin_id_hex, PIN, client_secret_hex) {
    ...
    error_code = this.ctx.MPIN.EXTRACT_PIN(this.ctx.MPIN.HASH_TYPE, mpin_id_bytes, PIN, client_secret_bytes);
    if (error_code !== 0) {
      return error_code;
    }
 ...
 */
  Mpin.prototype._pass1Request = function (mpin_id_hex, token_hex, timePermit_hex, PIN, epoch_days, X_hex) {
    ...
    error_code = this.ctx.MPIN
        .CLIENT_1(this.ctx.MPIN.HASH_TYPE, epoch_days, mpin_id_bytes, this.rng, this.X, PIN, token_bytes, this.SEC, U, UT, timePermit_bytes);
    if (error_code !== 0) {
 ...
 */
  Mpin.prototype._eMpinAuthenticateDet = function (mpinId_hex, clientCurrentTime, token_hex, timePermit_hex, pin,
    ...
    var hashedMpinId_ba = this.ctx.MPIN.HASH_ID(this.ctx.MPIN.HASH_TYPE, mpinId_ba);
    var A = this.ctx.ECP.mapit(hashedMpinId_ba);

    var nonce_hex = nonce_bn.toString();

    var pin_bn = this.ctx.BIG
        .fromBytes(this.ctx.MPIN.HASH_ID(this.ctx.MPIN.HASH_TYPE, this.ctx.MPIN.stringtobytes(pin)));
    var aA = A.mul(pin_bn);
    ...
    var T = this.ctx.ECP.mapit(this.ctx.MPIN.HASH_ID(this.ctx.MPIN.HASH_TYPE, TData));
    ...
    var y_bn = this.ctx.BIG
        .fromBytes(this.ctx.MPIN.HASH_ID(this.ctx.MPIN.HASH_TYPE, this.ctx.MPIN.stringtobytes(yData)));
 ...
 */
  Mpin.prototype._eMpinActivationCheckDet = function (mpinId_hex, clientSecret_hex, x_bn) {
    ...
    var mpinId_ba = this._hexToBytes(mpinId_hex);
    var A = this.ctx.ECP.mapit(this.ctx.MPIN.HASH_ID(this.ctx.MPIN.HASH_TYPE, mpinId_ba));
 ...
 */
  Mpin.prototype._eMpinCalcClientSecretWithActivationCode = function(mpinId_hex, point_hex, scalarVal, isEncode) {
    ...
    var hashedScalarVal_bn = this.ctx.BIG.fromBytes(this.ctx.MPIN.HASH_ID(this.ctx.MPIN.HASH_TYPE, scalarVal_ba));
 ...
 */
  Mpin.prototype._eMpinCalcClientSecretWithStringPin = function(mpinId_hex, point_hex, scalarVal, isEncode) {
    ...
    var hashedScalarVal_bn = this.ctx.BIG
        .fromBytes(this.ctx.MPIN.HASH_ID(this.ctx.MPIN.HASH_TYPE, this.ctx.MPIN.stringtobytes(scalarVal)));
    var xA = A.mul(hashedScalarVal_bn);
