...
var mpinjs = (function () {
  ...
  Mpin.prototype.waitForMobileAuth = function (timeoutSeconds, requestSeconds, cb, cbStatus, useEMpin) {
    var self = this, _reqData = {};
        ...
        if (data.status === 'authenticate') {
          ...
          if (self.timeoutPeriod > 0) {
            ...
            self.intervalID2 = setTimeout(function () {
              self.waitForMobileAuth.call(self, timeoutSeconds, requestSeconds, cb, cbStatus, useEMpin);
            }, _requestPeriod);
            return;
